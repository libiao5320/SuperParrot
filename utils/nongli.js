...
const solarDay = date =>{
  ...
  // console.info("lDObj.dayCyl = " + lDObj.dayCyl);
  var tt = '【' + Animals[(date.getFullYear() - 4) % 12] + '】' + cyclical(lDObj.monCyl) + '月 ' + cyclical(lDObj.dayCyl++) + '日';
  return ( tt );
}
const solarDay2 = date => {
  var sDObj = new Date(date.getFullYear(), date.getMonth(), date.getDate());
  ...
  // cyclical(date.getFullYear() - 1900 + 36) + '年 ' +
  var tt = cDay(lDObj.month, lDObj.day);
  return ( tt );
}
const solarDay3 = date => {
